...
//
//import com.example.online_farm.Entity.Cart;
...
//   CartItem findByProductIdAndCartId(int productId, Cart cartId);
//   List<CartItem> findAllByProductId(int productId);
//   boolean existsByCartIdAndProductId(int productId, Cart cartId);
//}
